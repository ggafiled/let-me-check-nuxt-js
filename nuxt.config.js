export default {
    ...
    head: {
        ...
        link: [
            ...
            {
                rel: "stylesheet",
                href: "https://fonts.googleapis.com/css2?family=Athiti:wght@200;400&display=swap"
            }
        ],
        ...
        [
            "@nuxtjs/firebase",
            {
                config: {
                    ...
                    databaseURL: "https://let-me-check-42804-default-rtdb.asia-southeast1.firebasedatabase.app",
